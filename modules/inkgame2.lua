...
----------------------------------------------------------------------------
  For support head over to discord.gg/pealzware
----------------------------------------------------------------------------
]]
...
--game:GetService("Players").LocalPlayer:Kick("Pealzware Is Temporarily Down. Please wait while we bring it back discord.gg/pealzware :c")
local IS_DOWN = true

local commit = shared.CustomCommit and tostring(shared.CustomCommit) or shared.StagingMode and "staging" or "main"
...
if IS_DOWN and not shared.BYPASS_VW_PROTECTION then
    ...
    game:GetService("StarterGui"):SetCore("SendNotification", {
        ...
        Text = "Pealzware is currently down, but you can try the public beta version before it officially gets released :D",
    ...
    --[[game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "Pealzware | Ink Game",
        Text = "Pealzware is currently down! Please wait until we patch the anticheat once again :c",
        Duration = 10
    })

    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "Pealzware | Discord",
        Text = "Join discord.gg/pealzware for updates",
        Duration = 10
    })--]]
    ...
    --[[pcall(function()
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "Pealzware | Ink Game | Announcment",
    ...
    if (shared.CheatEngineMode or not verified) and not shared.AcceptedRisksOfBan then
        ...
        --[[if not shared.CheatEngineMode and not verified then
            ...
            game:GetService("StarterGui"):SetCore("SendNotification", {
                Title = "Pealzware | Currently Tested Executors",
    ...
    --[[if not hookmetamethod then
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "Pealzware - Anticheat Test | Ink Game",
            Text = "Your executor "..(hookmetamethod ~= nil and "supports ✅" or "doesn't support ❌").." the anticheat patch!",
            Duration = 10
        })
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "Pealzware - Anticheat Test | Ink Game",
            Text = "Please use a different executor! For support: discord.gg/pealzware",
            Duration = 10
        })
        return
    end--]]
    ...
    --[[pcall(function()
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "Pealzware | Announcment",
            Text = "Warning: Rebelling with Pealzware may lead to bans. Don't join Rebels and start a new game when one starts. Sorry for the inconvenience! We are working on it",
            Duration = 8
        })
    end)--]]
    ...
    if shared.VW_PUBLIC_TESTING_MODE then
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "Pealzware Public Testing",
            Text = "Make sure to report any bugs in discord.gg/pealzware!",
    ...
    task.spawn(function()
        pcall(function()
            ...
            --loadstring(game:HttpGet("https://raw.githubusercontent.com/1AreYouMental110/pealzware/"..tostring(commit).."/modules/inkgamereducer.lua", true))()
        end)
    end)
