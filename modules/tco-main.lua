...
-- Game routing is handled by loader.lua — no PlaceId guard needed here
...
local pealzwareRepo = 'https://raw.githubusercontent.com/1AreYouMental110/PealzwareUI/refs/heads/master/'
Library = loadstring(game:HttpGet(pealzwareRepo .. 'Library.lua'))()(pealzwareRepo)
